...
namespace CourseDeLevrierGraphique
{
    public partial class Form1 : Form
    {
        ...
        {
            int nombreLevrier;
            if (int.TryParse(txtNombreLevrier.Text, out nombreLevrier) && nombreLevrier >= 2 && nombreLevrier <= 17)
            {
            ...
            {
                MessageBox.Show("Veuillez entrer un nombre valide de lévriers entre 2 et 17.", "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        {
            if (int.TryParse(txtNombreLevrier.Text, out int numero) && numero >= 2 && numero <= 17)
            {
